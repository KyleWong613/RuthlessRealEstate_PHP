...
<center><br /><form name="search" method="post" action="PropertySearch.php" >
Search for Property: <input type="text" name="find" /> 
...
<br>
<center>
<input type="button" value="Add"  OnClick="window.location='PropertyAdd.php'">
</center>
<br><br><br>
...
<center><a href="showproperty.php" target="_blank" >
  <img src="Property.png" alt="PropertyBox" >
</a></center>
