...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="header">
      ...
      <!-- insert body here-->
<center><h2>Features List</h2></center>
<?php
include("connection.php");
$conn = oci_connect($UName,$PWord,$DB) or die("Couldn't logon.");
$query="SELECT * FROM Feature ORDER BY feature_id ASC";
$stmt = oci_parse($conn,$query);
oci_execute($stmt);
	echo"<center>";
	echo "<table style='width:50%'; border='3'; cellpadding='5'>";
    echo"<tr>";
    echo"<th>Feature ID</th>";
    echo"<th>Feature Name</center></th>";
    ...
    echo "</tr>";
        while ($row = oci_fetch_array ($stmt))
           ...
           echo "<td>$row[1]</td>";
           echo "<td><center><a href='FeatureUpdate.php?feature_id=$row[0]&Action=Update'> Update </a></center></td>";
           echo "<td><center><a href='FeatureUpdate.php?feature_id=$row[0]&Action=Delete'> Delete </a></center></td>";
	       echo "</tr>";
                }
           echo "</table>";
		   echo "</center>";
?>
        <br>
        <center><input type="button" value="Add" OnClick="window.location='FeatureAdd.php'"></center>
...
<center<<a href="showfeature.php" target="_blank">
          <img src="Feature.png" alt="TypeBox"></center>
        </a>
